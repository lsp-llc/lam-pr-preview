...
(function () {
  ...
  // Mascots stay on the homepage and the interactive tools. Guides, articles
  // and policy pages are for reading, so nothing animates over the text there.
  var CREATURE_PAGES = ['/', '/index.html', '/local-ai-models.html', '/builder.html',
    '/model-builder.html', '/recommend.html', '/token-simulator.html', '/sentiment.html'];
  if (CREATURE_PAGES.indexOf(window.location.pathname) === -1) return;
  ...
  /* Stork banner retired 2026-09-25: it surfaced internal audit notes and
     unverified tips to visitors. spawnStork() is kept for reference only. */
